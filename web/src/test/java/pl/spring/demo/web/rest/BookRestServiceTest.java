...
public class BookRestServiceTest {
    ...
    @Test
    public void testShouldCheckIfBookServicWasInvokedeWhenDeleteAnyBook() throws Exception {
    	// given
    	Long id = 1L;
    	Mockito.when(bookService.delete(id)).thenReturn(new BookTo());
    	// when
    	ResultActions resultActions = this.mockMvc.perform(delete("/delete_book/" + id).accept(MediaType.APPLICATION_JSON));
    	// then
